...
CAN_FRAME_TYPE KANGOO_423 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
...
CAN_FRAME_TYPE KANGOO_79B = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_STANDARD_FRAME,
                                         }},
...
CAN_FRAME_TYPE KANGOO_79B_Continue = {.FIR = {.B =
                                                  {
                                                      .DLC = 8,
                                                      .FF = CAN_STANDARD_FRAME,
                                                  }},
...
void receive_can_battery(CAN_FRAME_TYPE rx_frame)  //GKOE reworked
{
