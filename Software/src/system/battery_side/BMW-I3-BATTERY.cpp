...
CAN_FRAME_TYPE BMW_592_0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_STANDARD_FRAME,
                                        }},
...
CAN_FRAME_TYPE BMW_592_1 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_STANDARD_FRAME,
                                        }},
...
static uint8_t calculateCRC(CAN_FRAME_TYPE rx_frame, uint8_t length, uint8_t initial_value) {
...
void receive_can_battery(CAN_FRAME_TYPE rx_frame) {
