...
CAN_FRAME_TYPE SANTAFE_200 = {.FIR = {.B =
                                          {
                                              .DLC = 8,
...
CAN_FRAME_TYPE SANTAFE_2A1 = {.FIR = {.B =
                                          {
                                              .DLC = 8,
                                              .FF = CAN_STANDARD_FRAME,
                                          }},
...
CAN_FRAME_TYPE SANTAFE_2F0 = {.FIR = {.B =
                                          {
                                              .DLC = 8,
                                              .FF = CAN_STANDARD_FRAME,
                                          }},
...
CAN_FRAME_TYPE SANTAFE_523 = {.FIR = {.B =
                                          {
                                              .DLC = 8,
                                              .FF = CAN_STANDARD_FRAME,
                                          }},
...
uint8_t CalculateCRC8(CAN_FRAME_TYPE rx_frame) {
  int crc = 0;
