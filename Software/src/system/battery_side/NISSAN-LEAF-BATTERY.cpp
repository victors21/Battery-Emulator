...
CAN_FRAME_TYPE LEAF_GROUP_REQUEST = {.FIR = {.B =
                                                 {
                                                     .DLC = 8,
                                                     .FF = CAN_STANDARD_FRAME,
                                                 }},
...
const CAN_FRAME_TYPE LEAF_NEXT_LINE_REQUEST = {.FIR = {.B =
                                                           {
                                                               .DLC = 8,
                                                               .FF = CAN_STANDARD_FRAME,
                                                           }},
...
bool is_message_corrupt(CAN_FRAME_TYPE rx_frame) {
  uint8_t crc = 0;
