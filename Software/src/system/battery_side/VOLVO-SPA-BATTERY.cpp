...
CAN_FRAME_TYPE VOLVO_536 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
...
CAN_FRAME_TYPE VOLVO_CELL_U_Req = {
    .FIR = {.B =
                {
                    .DLC = 8,
                    .FF = CAN_STANDARD_FRAME,
...
CAN_FRAME_TYPE VOLVO_FlowControl = {.FIR = {.B =
                                                {
                                                    .DLC = 8,
                                                    .FF = CAN_STANDARD_FRAME,
                                                }},
...
CAN_FRAME_TYPE VOLVO_SOH_Req = {.FIR = {.B =
                                            {
                                                .DLC = 8,
                                                .FF = CAN_STANDARD_FRAME,
                                            }},
