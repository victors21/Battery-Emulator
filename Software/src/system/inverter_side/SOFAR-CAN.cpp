...
CAN_FRAME_TYPE SOFAR_351 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x351,
                            .data = {0xC6, 0x08, 0xFA, 0x00, 0xFA, 0x00, 0x80, 0x07}};
CAN_FRAME_TYPE SOFAR_355 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_356 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_30F = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_359 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_35E = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_35F = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_35A = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_670 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_671 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_672 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_673 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_680 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_681 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_682 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x682,
                            .data = {0x00, 0xB6, 0x0C, 0xB3, 0x0C, 0xB4, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_683 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x683,
                            .data = {0x00, 0xB6, 0x0C, 0xB3, 0x0C, 0xB4, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_684 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x684,
                            .data = {0x00, 0xB6, 0x0C, 0xB3, 0x0C, 0xB4, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_685 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_690 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_691 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_6A0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_6B0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_6C0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x6C0,
                            .data = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
CAN_FRAME_TYPE SOFAR_770 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_771 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x771,
                            .data = {0x00, 0x42, 0x48, 0x55, 0x35, 0x31, 0x32, 0x30}};
CAN_FRAME_TYPE SOFAR_772 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x772,
                            .data = {0x00, 0x32, 0x35, 0x45, 0x50, 0x43, 0x32, 0x31}};
CAN_FRAME_TYPE SOFAR_773 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x773,
                            .data = {0x00, 0x34, 0x32, 0x36, 0x31, 0x36, 0x32, 0x00}};
CAN_FRAME_TYPE SOFAR_780 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_781 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x781,
                            .data = {0x00, 0xEB, 0x0C, 0xED, 0x0C, 0xED, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_782 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x782,
                            .data = {0x00, 0xEB, 0x0C, 0xED, 0x0C, 0xED, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_783 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x783,
                            .data = {0x00, 0xEB, 0x0C, 0xED, 0x0C, 0xED, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_784 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x784,
                            .data = {0x00, 0xEB, 0x0C, 0xED, 0x0C, 0xED, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_785 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x785,
                            .data = {0x00, 0xEB, 0x0C, 0xED, 0x0C, 0xED, 0x0C, 0x00}};
CAN_FRAME_TYPE SOFAR_790 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_791 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
                            .MsgID = 0x791,
                            .data = {0x00, 0xCD, 0x00, 0xCF, 0x00, 0x00, 0x00, 0x00}};
CAN_FRAME_TYPE SOFAR_7A0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_7B0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
CAN_FRAME_TYPE SOFAR_7C0 = {.FIR = {.B =
                                        {
                                            .DLC = 8,
                                            .FF = CAN_EXTENDED_FRAME,
                                        }},
...
void receive_can_sofar(CAN_FRAME_TYPE rx_frame) {
