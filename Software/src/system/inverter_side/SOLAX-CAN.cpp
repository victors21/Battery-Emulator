...
CAN_FRAME_TYPE SOLAX_1801 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
...
CAN_FRAME_TYPE SOLAX_1872 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1873 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1874 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1875 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1876 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1877 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x1877,
                             .data = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}};
CAN_FRAME_TYPE SOLAX_1878 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1879 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x1879,
                             .data = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}};
CAN_FRAME_TYPE SOLAX_1881 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_1882 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE SOLAX_100A001 = {.FIR = {.B =
                                            {
                                                .DLC = 0,
                                                .FF = CAN_EXTENDED_FRAME,
                                            }},
...
void CAN_WriteFrame(CAN_FRAME_TYPE* tx_frame) {
#ifdef DUAL_CAN
...
void receive_can_solax(CAN_FRAME_TYPE rx_frame) {
