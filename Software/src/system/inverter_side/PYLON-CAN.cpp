...
CAN_FRAME_TYPE PYLON_7310 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
...
CAN_FRAME_TYPE PYLON_7320 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4210 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4220 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4230 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4240 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4250 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4260 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4270 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4280 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4290 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_7311 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x7311,
                             .data = {0x01, 0x00, 0x02, 0x01, 0x01, 0x02, 0x00, 0x00}};
CAN_FRAME_TYPE PYLON_7321 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
CAN_FRAME_TYPE PYLON_4211 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4211,
                             .data = {0xA5, 0x09, 0x30, 0x75, 0x9D, 0x04, 0x2E, 0x64}};
CAN_FRAME_TYPE PYLON_4221 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4221,
                             .data = {0x8C, 0x0A, 0xE9, 0x07, 0x4A, 0x79, 0x4A, 0x79}};
CAN_FRAME_TYPE PYLON_4231 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4231,
                             .data = {0xDF, 0x0C, 0xDA, 0x0C, 0x03, 0x00, 0x06, 0x00}};
CAN_FRAME_TYPE PYLON_4241 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4241,
                             .data = {0x7E, 0x04, 0x62, 0x04, 0x11, 0x00, 0x03, 0x00}};
CAN_FRAME_TYPE PYLON_4251 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4251,
                             .data = {0x03, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
CAN_FRAME_TYPE PYLON_4261 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4261,
                             .data = {0xAC, 0xC7, 0x74, 0x27, 0x03, 0x00, 0x02, 0x00}};
CAN_FRAME_TYPE PYLON_4271 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4271,
                             .data = {0x7E, 0x04, 0x62, 0x04, 0x05, 0x00, 0x01, 0x00}};
CAN_FRAME_TYPE PYLON_4281 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
                             .MsgID = 0x4281,
                             .data = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
CAN_FRAME_TYPE PYLON_4291 = {.FIR = {.B =
                                         {
                                             .DLC = 8,
                                             .FF = CAN_EXTENDED_FRAME,
                                         }},
...
void receive_can_pylon(CAN_FRAME_TYPE rx_frame) {
