...
const char* ssid = "PVS";          // Maximum of 63 characters;
const char* password = "0974880999";  // Minimum of 8 characters;
//const char* ssid = "AUTOLIKAR2";          // Maximum of 63 characters;
//const char* password = "autolikar";  // Minimum of 8 characters;
